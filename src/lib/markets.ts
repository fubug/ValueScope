...
export const markets: Record<MarketId, MarketMeta> = {
  ...
  us_nasdaq: { id: 'us_nasdaq', name: '美国', flag: '🇺🇸', indices: ['纳斯达克100'], dataSource: 'yfinance' },
  ...
  gold: { id: 'gold', name: '黄金', flag: '🥇', indices: ['XAUUSD'], dataSource: 'yfinance' },
  us_treasury: { id: 'us_treasury', name: '美债', flag: '📜', indices: ['10Y Treasury'], dataSource: 'FRED' },
};
